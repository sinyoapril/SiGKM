            ...
            <form action="{{ route('kelas.update', $kelas->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_kelas" class="form-control @error('nama_kelas') is-invalid @enderror"
                        value="{{ old('nama_kelas', $kelas->nama_kelas) }}" placeholder="Contoh: A, B, Reguler A">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="keterangan" rows="3" class="form-control @error('keterangan') is-invalid @enderror"
                        placeholder="Masukkan keterangan jika ada">{{ old('keterangan', $kelas->keterangan) }}</textarea>

...
@section('content')
    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
        <h4 class="fw-bold mb-0">Tambah Semester</h4>
    ...
    <div class="card">
        <h5 class="card-header">Form Tambah Semester</h5>
            ...
            <form action="{{ route('semester.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="nama" class="form-select @error('nama') is-invalid @enderror">
                        ...
                        <option value="ganjil" {{ old('nama') == 'ganjil' ? 'selected' : '' }}>
                            Ganjil
                        </option>
                        <option value="genap" {{ old('nama') == 'genap' ? 'selected' : '' }}>
                            Genap
                        </option>
                    </select>
